...
public class AlbumController extends BaseController {
    ...
    public Map<String, Object> add(@RequestBody AlbumBean bean) {
    	Gson gson = new Gson();
    	log.info(" /user/album/add---:" + gson.toJson(bean));
    ...
    public Map<String, Object> edit(@RequestBody AlbumBean bean) {
    	Gson gson = new Gson();
    	log.info(" /user/album/edit---:" + gson.toJson(bean));
    ...
    public Map<String, Object> findById(Long id) {
    	log.info(" /user/album/findById---:" + id);
    ...
    public Map<String, Object> findByPage(QueryBean query) {
    	log.info(" /user/album/findByPage");
