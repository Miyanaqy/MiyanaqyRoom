...
public class PhotoController extends BaseController {
    ...
    public Map<String, Object> add(@RequestBody PhotoBean bean) {
    	Gson gson = new Gson();
    	log.info(" /user/photo/add---:" + gson.toJson(bean));
    ...
    public Map<String, Object> edit(@RequestBody PhotoBean bean) {
    	Gson gson = new Gson();
    	log.info(" /user/photo/edit---:" + gson.toJson(bean));
    ...
    public Map<String, Object> findById(Long id) {
    	log.info(" /user/photo/findById---:" + id);
    ...
    public Map<String, Object> findByPage(QueryBean query) {
    	log.info(" /user/photo/findByPage");
